...
export const getBranchStats = (id) =>
  apiClient.get(`/branches/${id}/stats`).then((r) => r.data);
...
export const hardDeleteBranch = (id) =>
  apiClient.delete(`/branches/${id}/hard`).then((r) => r.data);
