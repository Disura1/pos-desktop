      ...
      <div className="grid-3">
        {discounts.map((d) => (
          <div
            ...
            className="card"
            style={{
              borderTop: `4px solid ${d.is_active ? "var(--pink)" : "var(--border)"}`,
            }}
          >
            {/* This inner wrapper fades only the content, not the buttons */}
            <div style={{ opacity: d.is_active ? 1 : 0.5 }}>
              <div
                style={{
                  display: "flex",
                  justifyContent: "space-between",
              ...
              >
                ...
                <span
                  className={`badge ${d.is_active ? "badge-success" : "badge-gray"}`}
                >
              ...
              >
                {d.type === "percentage"
                  ? "Percentage Discount"
                  : "Fixed Amount Off"}
                {parseFloat(d.min_amount) > 0 &&
                  ` · Min: ${fmtCurrency(d.min_amount)}`}
              </div>
            </div>
            {/* Buttons always full opacity */}
        ...
        {discounts.length === 0 && (
          <div style={{ gridColumn: "1/-1" }}>
            <div className="empty-state">
              ...
              <div className="empty-state-text">No discounts created yet</div>
            </div>
          </div>
        )}
      </div>
